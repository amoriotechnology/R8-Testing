                            ...
                            <table class="table table-bordered table-hover" id="truckingTable">
                                ...
                                <?php foreach($purchase_info as $pf){ ?>
                                    <tr>
                                       ...
                                       <td class="wt">
                                            <input type="text" name="product_quantity[]" id="cartoon_1" required="" min="0" class="form-control text-right store_cal_1" onkeyup="total_amt(1);"  placeholder="0.00" value=<?php echo $pf['qty'] ; ?> tabindex="6"/>
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><span class='form-control' style='background-color: #eee;'><?php echo $currency;  ?>
                                            <input type="text" id="Total"  name="total" value=<?php  echo $purchase_info[0]['total_amt']; ?> readonly="readonly" />
                                  </span></td>
